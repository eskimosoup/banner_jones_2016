function teamMembersSlick(slidesToShowCount) {
  if(typeof partialWidth !== 'undefined') {
    slidesToShowCount = partialWidth;
  }

  $('.slider-team-members-slick').on('init', function() {
    $('.slider-team-member.slick-current .slider-team-member-profile-card-update').click();
    $('.slider-team-members-slick img').trigger('unveil');
  });
