  ...
  describe "#create" do
    context "when Event is valid" do
      it "redirects to index on normal save" do
        ...
        post :create, commit: "Save", event: event.attributes
      ...
      it "redirects to edit on save and continue editing" do
        ...
        post :create, commit: "Save and continue editing", event: event.attributes
  ...
  describe "#update" do
    context "when Event is valid" do
      it "redirects to index on normal save" do
        ...
        patch :update, id: event.id, commit: "Save", event: event.attributes
      ...
      it "redirects to edit on save and continue editing" do
        ...
        patch :update, id: event.id, commit: "Save and continue editing", event: event.attributes
